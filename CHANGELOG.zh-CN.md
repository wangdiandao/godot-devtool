...
- 从工作树删除本地 dock 截图产物，并忽略未来的 `dock-*.png` 可视化验证截图。
- 将 package、插件、Skill、README、CHANGELOG、ROADMAP、验证 metadata 和本地 build metadata 同步到 `3.0.1`。
...
- 将 package、插件、Skill、README、CHANGELOG、ROADMAP、验证 metadata 和本地 build metadata 同步到 `3.0.0`。
