...
`godot-devtool` is a Godot 4 MCP server for AI-assisted project inspection, editing, validation, and runtime automation. Version 2.8.0 splits the large server method surface into focused implementation modules, hardens Godot process failure handling, and keeps the 2.7 dock/runtime bridge fixes.
