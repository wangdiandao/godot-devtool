...
[![Version](https://img.shields.io/badge/version-2.6.3-blue.svg)](CHANGELOG.zh-CN.md)
...
`godot-devtool` 是面向 Godot 4 的 MCP server，用于让 AI 助手检查、编辑、验证和自动化运行中的 Godot 项目。2.6.3 修复 Steam 版 Godot headless 启动问题，在执行 headless 操作前显式写入可用日志文件。
