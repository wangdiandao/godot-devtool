...
class GodotServerResourceMethods {
...
export function registerGodotServerResourceMethods(GodotServerCtor: any): void {
  for (const name of Object.getOwnPropertyNames(GodotServerResourceMethods.prototype)) {
    if (name === 'constructor') continue;
    const descriptor = Object.getOwnPropertyDescriptor(GodotServerResourceMethods.prototype, name);
    if (descriptor) {
