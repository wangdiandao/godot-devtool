  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        mode: {
          type: 'string',
          enum: ['headless', 'editor_live'],
          description: 'Use headless for saved file edits or editor_live to modify the currently open editor scene through UndoRedo',
        },
        autoSave: { type: 'boolean', description: 'When mode is editor_live, save the edited scene after the live change. Defaults to false.' },
        timeoutMs: { type: 'number', description: 'When mode is editor_live, command timeout in milliseconds. Defaults to 10000.' },
