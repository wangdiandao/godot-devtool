...
const ROUTED_COMPATIBILITY_TOOLS: CompatibilityToolRoute[] = [
  ...
  { toolName: 'tilemap_get_cell', canonicalTool: 'tilemap', fixedArgs: { action: 'get_cell' } },
  { toolName: 'tilemap_get_used_cells', canonicalTool: 'tilemap', fixedArgs: { action: 'get_used_cells' } },
  { toolName: 'tilemap_clear', canonicalTool: 'tilemap', fixedArgs: { action: 'clear' } },
  ...
  { toolName: 'move_node', canonicalTool: 'node_move' },
...
const NATIVE_COMPATIBILITY_TOOL_NAMES = [
  ...
  'find_nearby_nodes', 'navigate_to', 'move_to', 'set_theme_color', 'set_theme_constant',
